...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_Tutorial = __nuxt_component_0;
  _push(ssrRenderComponent(_component_Tutorial, _attrs, null, _parent));
}
...
//# sourceMappingURL=index-678b47bc.mjs.map
